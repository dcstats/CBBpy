...
SCOREBOARD_URL = "https://www.espn.com/mens-college-basketball/scoreboard/_/date/{}/seasontype/2/group/50"
...
def _get_game_pbp_helper(gamepackage, game_id):
    ...
    reg_secs_left = [
        1200 + x if half_num == 1 else x for x, half_num in zip(hf_secs_left, halves)
    ]
